...
```sh
shasum -a 256 -c F1-Live-0.2.2-macOS-universal.zip.sha256
```
...
Session reminders are optional. To enable them, open **Settings → Notifications**, turn on **Session reminders**, and follow the permission introduction. New installations do not ask for notification access on launch.

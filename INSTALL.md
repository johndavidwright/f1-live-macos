...
Live timing is optional and requires your own paid OpenF1 account. In **Settings → OpenF1 Live Timing**, enter your **Client ID** and **Client Secret**, then choose **Save & Test Connection**. Credentials stay in this Mac’s Keychain. If an update requires permission to access saved credentials, choose **Authorize Saved Credentials** in Settings. All other features work without an OpenF1 account.
